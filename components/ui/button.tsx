...
const buttonVariants = cva(
  "relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg border bg-clip-padding font-medium text-sm outline-none transition-shadow before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    variants: {
      size: {
        default:
          "min-h-7 px-[calc(--spacing(2.5)-1px)] py-[calc(--spacing(1)-1px)]",
        icon: "size-7",
        "icon-lg": "size-8",
        "icon-sm": "size-6",
        "icon-xl": "size-9 [&_svg:not([class*='size-'])]:size-4.5",
        "icon-xs":
          "size-5 rounded-md before:rounded-[calc(var(--radius-md)-1px)]",
        lg: "min-h-8 px-[calc(--spacing(3)-1px)] py-[calc(--spacing(1.5)-1px)]",
        sm: "min-h-6 gap-1.5 px-[calc(--spacing(2)-1px)] py-[calc(--spacing(0.5)-1px)]",
        xl: "min-h-9 px-[calc(--spacing(3.5)-1px)] py-[calc(--spacing(1.5)-1px)] text-base [&_svg:not([class*='size-'])]:size-4.5",
        xs: "min-h-5 gap-1 rounded-md px-[calc(--spacing(1.5)-1px)] py-[calc(--spacing(0.5)-1px)] text-xs before:rounded-[calc(var(--radius-md)-1px)] [&_svg:not([class*='size-'])]:size-3",
      },
      variant: {
        default:
        ...
        glow: "not-disabled:inset-shadow-[0_1px_--theme(--color-white/24%)] border-glow bg-glow text-background shadow-glow/32 shadow-md hover:bg-glow/90 hover:shadow-glow/40 [&:is(:active,[data-pressed])]:inset-shadow-[0_1px_--theme(--color-black/8%)] [&:is(:disabled,:active,[data-pressed])]:shadow-none",
      },
    },
  },
);
