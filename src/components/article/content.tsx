...
// Guard against multiple hook registrations and SSR
    ...
    <div className="mt-2">
      <article>
        ...
        <div className={viewMode !== "iframe" ? "block" : "hidden"}>
          ...
          {isError &&
            (() => {
              const details = error instanceof ArticleFetchError ? (error.details ?? {}) : {};
              const detailsWithOriginalError = details as { originalError?: string; statusCode?: number };
              const appError =
                error instanceof ArticleFetchError && error.errorType
                  ? ({
                      ...
                      originalError: detailsWithOriginalError.originalError,
                      debugContext: error.debugContext,
                      statusCode: detailsWithOriginalError.statusCode,
                    } as AppError)
                  : ({
                      type: "NETWORK_ERROR",
      ...
      {import.meta.env.DEV && debugContext && (
